 ...
 if(isset($_GET['delet']))
   {
            ...
            $query= mysqli_query($db, $update_query);
                ...
                if($query)
                        ...
                        window.location='subshow_type.php';
                        </script>";
                        } 
                                        ...
                                        <tbody>                          
                                            ...
                                            ?>
                                                 <tr>
                                                    ...
                                                    <td> <a href="subshow_type.php?delet=<?php echo $row["id"]; ?>"><i class="fa fa-trash" style="width:20px;color:#ec2d5d;"></i></a></td>
                                                     <td> <a href="subshow_type.php?edit=<?php echo $row["id"]; ?>"><i class="fa fa-edit" style="width:20px;color:#ec2d5d;"></i></a></td>
                                                </tr>
                                                    <?php } ?>
                                        </tbody>
                            </table>
