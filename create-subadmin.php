                                                ...
                                                <div class="col col-md-12">
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col col-md-6">
                                                            ...
                                                            <input type="text" placeholder="Mobile no" class="form-control"name="mobile" pattern="[1-9]{1}[0-9]{9}" title="Enter 10 digit mobile number" value="<?php echo $mobile; ?>"required>
                                                        </div>
                                                        <div class="col col-md-6">
                                                            <label for="company" class=" form-control-label">Email</label>
                                                            <input type="text" placeholder="Email" class="form-control"name="email" value="<?php echo $email;?>" required>
                                                        </div>
                                                    </div>
