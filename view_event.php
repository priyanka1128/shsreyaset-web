		 ...
		 /*----------------------------------------------------------------------------------------------------------*/
                                    ...
                                    <tr>
                                        <td data-title="type"><?php echo $row["type"];?></td>
                                         ...
                                         <td data-title="theater"><?php echo $nn["name"]; ?></td>
                                       ...
                                       <td data-title="videolink"><a href='<?php echo $row["videolink"]; ?>'><?php echo $row["videolink"]; ?></a></td>
                                        ...
                                        <td> <a href="view_event.php?delet=<?php echo $row["id"]; ?>"><i class="fa fa-trash" style="width:20px;color:#ec2d5d;"></i></a>
                                        <a href="editevent.php?edit=<?php echo $row["id"];?>"><i class="fa fa-edit" style="width:20px;color:#ec2d5d;"></i></a></td>
                                    </tr>
